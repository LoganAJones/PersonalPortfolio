...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Web Designer", "UI/UX Designer", "Software Engineer"  ];
  const period = 2000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Logan`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer", Software Engineer ]'><span className="wrap">{text}</span></span></h1>
                  <p>In the upcoming Spring, I am poised to attain my Bachelor of Engineering degree in Software Engineering, alongside a minor in Mathematics from the esteemed Lipscomb University. In 2018, I successfully completed an 18-week Front-end Developer bootcamp, called Launch Academy, located in Boston. For the past three years, I have had the privilege of being an integral part of the software engineering team at binx health. During this time, we were able to develop a pioneering digital health platform that has generated tens of millions in global revenue since its launch in 2019.</p>
